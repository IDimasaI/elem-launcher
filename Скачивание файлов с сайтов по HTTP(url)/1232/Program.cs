...
public class DownloadFileForm : Form
{
    ...
    public DownloadFileForm()
    {
        ...
        Label helpLabel = new Label
        {
            ...
            Text = "Не забудьте указать расширение"
        };
        ...
        Icon = new System.Drawing.Icon("3.ico");
        Text = "Загрузка файла";
        Size = new System.Drawing.Size(500, 200); //Размер формы
    }
    ...
    private void DownloadButton_Click(object sender, EventArgs e)
    {
        ...
        {         // Устанавливаем URL-адрес файла и путь сохранения
            ...
            string savePath = "download/" + savePathTextBox.Text;
